...
<html lang="en">
 ...
 <body>
   ...
   <div class="wrapper">
        <!-- START LEFT COLUMN -->
      <main>
        <h2 class="subheader">Youtube Webcam</h2>
        <div class='embed-container'><iframe src='https://www.youtube.com/embed/pT9_HJr-nso?autoplay=1' frameborder='0' allowfullscreen allow=”autoplay”></iframe></div>
      </main>
        <!-- END LEFT COLUMN -->
        ...
        <aside>
        <h3>DOT Webcam</h3>
        <div class='embed-container'><iframe src='https://www.travelmidwest.com/lmiga/snapshot?id=IL-KANECOUNTY-63' frameborder='0' allowfullscreen></iframe></div>
        </aside>
        <!-- END RIGHT COLUMN -->
